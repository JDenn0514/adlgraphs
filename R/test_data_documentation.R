...
#'   \item{pol_part_rally}{Attended a political rally, speech or campaign event}
#'   \item{pol_part_worked}{Worked or volunteered for a political party, candidate or campaign}
#'   \item{pol_part_contact}{Contacted an elected official}
#'   \item{pol_part_money}{Contributed money to a candidate running for public office or to a group working to elect a candidate}
#'   \item{pol_part_social}{Publicly expressed your support for a political candidate on Facebook, Twitter/X, Instagram, or other social media}
#'   \item{pol_part_attended}{Attended government meetings in your community, such as city or town council meetings}
#'   \item{pol_part_none}{None of the above}
...
#'   \item{edu_f2}{What is the highest level of school you have completed or the highest degree you have received?}
#'   \item{top_rev}{An ideal society requires some groups to be on top and others to be on the bottom}
#'   \item{inferior_rev}{Some groups of people are simply inferior to other groups}
#'   \item{dominate_flip}{One group should dominate in society}
#'   \item{deserving_flip}{Groups at the bottom are not just as deserving as groups at the top}
#'   \item{sdo_sum}{Social Dominance Orientation}
#'   \item{sdo_avg}{Social Dominance Orientation}
#'   \item{pol_part_sum}{Political Participation}
#'   \item{controlled_rev}{Much of our lives are being controlled by plots hatched in secrecy}
#'   \item{small_rev}{Even though we live in a democracy, a few people will always run things anyway}
#'   \item{run_rev}{The people who really "run" the country are not known to the voters}
#'   \item{big_events_rev}{Big events like wars, recessions, and the outcomes of elections are controlled by small groups of people who are working in secret against the rest of us}
#'   \item{acts_sum}{Conspiracy Theory Belief}
