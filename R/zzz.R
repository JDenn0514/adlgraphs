.onAttach <- function(...) {
  ...
  assign("use_roboto", fonts_present, envir = adlgraphs_global)
  ...
  if (get("use_roboto", envir = adlgraphs_global)) {
    ...
    assign(
      ...
      list(
        heavy = list(
          family = adlgraphs_global$preferred_font$heavy,
          face = "plain"
        ),
        bold = list(
          family = adlgraphs_global$preferred_font$bold,
          face = "plain"
        ),
        regular = list(
          family = adlgraphs_global$preferred_font$regular,
          face = "plain"
        ),
        light = list(
          family = adlgraphs_global$preferred_font$light,
          face = "plain"
        )
      ),
