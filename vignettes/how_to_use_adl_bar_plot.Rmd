...
test_data %>% 
  ...
  labs(
    ...
    y = NULL,
    title = "People {#14A2FCFF With} a Bachelor's Degree Are More Politically Active than People {#B0B1B3FF Without} a Bachelor's Degree",
  )
...
test_data %>% 
  ...
  labs(
    x = NULL,
    y = NULL,
    title = "{#14A2FCFF Conspiracy Theory Belief} Is Higher than {#B0B1B3FF Social Dominance Orientation} Across All Education Levels",
  )
