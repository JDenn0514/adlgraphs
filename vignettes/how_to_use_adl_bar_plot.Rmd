...
test_data %>% 
  ...
  labs(
    x = "Percentage who agree with each statement",
    y = NULL,
    title = "People {#14A2FCFF with} and {#B0B1B3FF without} a Bachelor's Degree Agree with Conspiratorial Statements at Similar Rates",
  )
...
test_data %>% 
  ...
  labs(
    x = "Number of Actions Related to Political Participation People Have Done",
    y = NULL,
    title = "People {#14A2FCFF with} a Bachelor's degree are slightly more politically active than people {#B0B1B3FF without} a Bachelor's Degree",
  )
...
test_data %>% 
  ...
  labs(
    x = NULL,
    y = NULL,
    title = "{#14A2FCFF Conspiracy Theory Belief} Is Consistently Higher than {#B0B1B3FF Social Dominance Orientation} Across All Education Levels",
  )
